package pl.karas.bikehouseorders.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, pl.karas.bikehouseorders.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, pl.karas.bikehouseorders.repository.UserRepository.USERS_BY_EMAIL_CACHE);
