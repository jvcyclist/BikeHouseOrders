...
import pl.karas.bikehouseorders.config.audit.AuditEventConverter;
import pl.karas.bikehouseorders.domain.PersistentAuditEvent;
...
import static pl.karas.bikehouseorders.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
