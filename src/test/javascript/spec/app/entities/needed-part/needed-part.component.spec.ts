...
describe('Component Tests', () => {
  describe('NeededPart Management Component', () => {
    let comp: NeededPartComponent;
    let fixture: ComponentFixture<NeededPartComponent>;
    let service: NeededPartService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [BikehouseordersTestModule],
        declarations: [NeededPartComponent],
        providers: [
          {
        ...
        .overrideTemplate(NeededPartComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(NeededPartComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.neededParts && comp.neededParts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
